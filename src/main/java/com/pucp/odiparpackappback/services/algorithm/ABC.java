...
//                }
    ...
    public boolean asignarPedidoPoblacionInicial2(PedidoModel pedido, int opcion) {
    ...
    public boolean kShortestPathRoutingPedido2(PedidoModel pedido, int k, int opcion) {
    ...
    public boolean asignarPedidoRutaVehiculo2(PedidoModel pedido, Ruta ruta, int opcion) {
        ArrayList<UnidadTransporteModel> vehiculos;
        if(opcion == 0) {
            vehiculos = Mapa.vehiculosSimulacion;
        }else{
