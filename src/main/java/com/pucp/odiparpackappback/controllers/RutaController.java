    ...
    public List<RutaConArraySegHorasLl> ListarRutasSimulacion() {
        try {
            ...
            for (int i = 0; i < Mapa.rutasSimulacion.size(); i++) {
                ...
                RutaConArraySegHorasLl auxRutaG = new RutaConArraySegHorasLl((long) i, Mapa.rutasSimulacion.get(i).getIdRuta(), Mapa.rutasSimulacion.get(i).getIdUnidadTransporte(), auxAI, auxNombreProvincias, Mapa.rutasSimulacion.get(i).getHorasDeLlegada(), codigoPlaca, pedidosParciales);
                auxRutasG.add(auxRutaG);
            }
            return auxRutasG;
        } catch (Exception ex) {
    ...
    public List<RutaConArraySegHorasLl> ListarRutasDiaDia() {
        try {
            ...
            for (int i = 0; i < Mapa.rutasDiaDia.size(); i++) {
                ...
                RutaConArraySegHorasLl auxRutaG = new RutaConArraySegHorasLl((long) i, Mapa.rutasDiaDia.get(i).getIdRuta(), Mapa.rutasDiaDia.get(i).getIdUnidadTransporte(), auxAI, auxNombreProvincias, Mapa.rutasDiaDia.get(i).getHorasDeLlegada(), codigoPlaca, pedidosParciales);
                auxRutasG.add(auxRutaG);
            }
            return auxRutasG;
        } catch (Exception ex) {
